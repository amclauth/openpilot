...
private:
  ...
  QSet<QString> deviceManagementKeys = {"DeviceShutdown", "FireTheBabysitter", "HigherBitrate", "IncreaseThermalLimits", "LowVoltageShutdown", "NoLogging", "NoUploads", "UseKonikServer"};  // FireTheBabysitter change - added "FireTheBabysitter" to set
